                ...
                <td bgcolor="#EEEEEE">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td align="left" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label19" runat="server" Text="Contexto Interno:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtContextoInt" runat="server" Width="800px" CssClass="Apariencia" Height="42px"
                                    Columns="100" Rows="8" TextMode="MultiLine" Font-Size="10pt" Font-Bold="False"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label20" runat="server" Text="Contexto Externo:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtContextoExt" runat="server" Width="800px" CssClass="Apariencia" Height="42px"
                                    Columns="100" Rows="8" TextMode="MultiLine" Font-Size="10pt" Font-Bold="False"></asp:TextBox>
